...
import com.hangyeolee.pdf.core.exceptions.CellOutOfGridLayoutException;
import com.hangyeolee.pdf.core.exceptions.LayoutSizeException;
...
public class PDFGridLayout extends PDFLayout{
    ...
    public PDFGridLayout addCell(int row, int column, PDFGridCell cell){
        ...
        if(orientation == Orientation.Vertical)
            ...
            updateOccupancyGridH(position, cell.rowSpan);
        cell.setPosition(position);
        cells.add(cell);
        return this;
    }
